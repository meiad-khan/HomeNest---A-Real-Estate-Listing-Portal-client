    ...
    >
      {slides.map((slide) => (
        <SwiperSlide key={slide.id}>
          <div className="w-full h-full flex flex-col md:flex-row bg-gray-50 overflow-hidden rounded-xl shadow-lg">
            {/* Left Info Panel (CLEAR) */}
            <div className="w-full md:w-1/2 px-6 md:px-16 py-10 flex flex-col justify-center h-full bg-gray-50 z-10 text-center md:text-left">
